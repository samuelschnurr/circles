    ...
    internal static List<Advertisement> GetAdvertisements()
    {
        List<Advertisement> advertisements = new()
        {
            ...
            new Advertisement
            {
                ...
                Description = "I've always had a passion for art, which is why I'm thrilled to offer custom hand-painted portraits. Each artwork is a labor of love, capturing the essence of your favorite photos in a unique and beautiful way. I take great pride in my work, ensuring that every brushstroke is infused with passion and creativity.\nnWhen you commission a custom portrait from me, you're not just receiving a piece of art; you're receiving a piece of your own history. I pour my heart into every painting, striving to capture the emotions, details, and nuances that make your memories special.\nnUsing high-quality canvas and professional-grade paints, I create portraits that will stand the test of time. Whether it's a portrait of a loved one, a cherished pet, or a breathtaking landscape, my goal is to exceed your expectations.\nnElevate your decor with a personalized hand-painted portrait that tells your unique story. Each stroke of the brush adds a layer of meaning and beauty to your life, making your surroundings more than just walls; they become a gallery of your most cherished moments.",
                Price = 19.99m,
            ...
            new Advertisement
            {
                ...
                Description = "If you're an outdoor enthusiast like me, you'll appreciate this camping tent for two. It has been my reliable shelter in various weather conditions, and it's time for it to accompany someone else on their adventures.\nnSetting it up is a breeze, thanks to its intuitive design and color-coded poles. Even if you're new to camping, you'll have this tent ready in minutes, allowing you to focus on the beauty of the great outdoors.\nnThe durable materials and waterproof rainfly ensure that you stay dry and comfortable, no matter the weather. Whether you're camping in the wilderness, by a serene lakeside, or under the starry night sky, this tent provides the perfect sanctuary.\nnInside, you'll find ample space for two with storage pockets to keep your gear organized. The mesh windows offer ventilation, and the sturdy zippers ensure easy access. It's your home away from home, designed for adventurers who appreciate both comfort and simplicity.\nnEmbark on your next camping trip with confidence, knowing you have a trustworthy companion in this tent. Create lasting memories in the great outdoors and let this tent be your reliable shelter on your next adventure.",
                Price = 79.99m,
            ...
            new Advertisement
            {
                ...
                Description = "Movie nights will never be the same with this Sony 65-inch 4K Ultra HD Smart LED TV. I've enjoyed countless cinematic experiences on this screen, and it delivers stunning visuals and immersive sound.\nnThe 4K Ultra HD resolution means you'll see every detail with crystal clarity, from the subtlest expressions on actors' faces to the breathtaking landscapes of your favorite films. This TV's Triluminos display technology enhances color accuracy, ensuring vibrant and lifelike images.\nnBut it's not just about visuals; the Dolby Atmos audio technology transports you into the heart of the action. Feel the rumble of a movie's soundtrack, the whispers of dialogue, and the roar of explosions, all with precision and depth.\nnWith smart functionality, this TV connects seamlessly to streaming platforms, giving you access to a vast library of content. You can binge-watch your favorite series, catch up on the latest documentaries, or enjoy family movie nights with ease.\nnMultiple HDMI and USB ports make connecting your devices a breeze. Whether you're a gaming enthusiast or want to showcase your latest vacation photos, this TV accommodates all your entertainment needs.\nnGet ready to be captivated by the world of 4K. This Sony TV is more than just a screen; it's a gateway to a world of visual and auditory wonders. Transform your living room into a private cinema and immerse yourself in the magic of high-definition entertainment.\nnThese extended descriptions provide a deeper understanding of the products, emphasizing their unique features and benefits.",
                Price = 899.99m,
                CreatedBy = "jane.doe@schnurrio.invalid",
                Condition = AdvertisementCondition.VeryGood,
